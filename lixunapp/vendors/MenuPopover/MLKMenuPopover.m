...
#define MENU_POINTER_RECT       CGRectMake(frame.origin.x+frame.size.width*0.655, frame.origin.y, 23, 11)
...
- (id)initWithFrame:(CGRect)frame menuItems:(NSArray *)aMenuItems images:(NSArray *)aImages
{
